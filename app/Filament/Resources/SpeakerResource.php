                        ...
                        Group::make()
                            ...
                            ->schema([
                                ...
                                TextEntry::make('has_spoken')
                                    ->getStateUsing(function ($record) {//getStateUsing => It allows you to retrieve the current state or computed value dynamically based on the state of the object or the context.
